      ...
      >
        <div class="flex flex-row h-12 justify-items-center">
          ...
          <input
            ...
            class="border w-56 h-8 items-center justify-center content-center self-center py-2"
            type="text"
            name="name"
          >
        </div>
        ...
        <div class="flex flex-row h-12 justify-items-center">
          ...
          <input
            ...
            class="border w-96 h-8 items-center justify-center content-center self-center py-2"
            type="text"
            name="title"
          >
        </div><hr>
...
- 서비스 제공에 관한 문의 및 상담</textarea>
        ...
        <div class="flex row justify-end mt-4">
          <button>
            <input
              class="border hover:bg-violet-600 active:bg-violet-700 border-solid bg-[#1B426B] rounded-lg text-white font-sans w-24 text-sm"
              type="submit"
              value="글쓰기"
            >
          </button>
